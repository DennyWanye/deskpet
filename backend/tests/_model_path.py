...
## 为什么需要
此前各 model_required 测试**硬编码** `C:/Users/24378/AppData/Local/deskpet/
models/bge-m3-int8`。2026-06-02 实际踩到：用户把 DeskPet 用户数据迁到 F 盘
（`F:/DeskPetData/`）后，C: 路径空了 → **所有 model_required 测试整批 ERROR**
...
def _candidates() -> list[Path]:
    ...
    cands += [
        Path(r"C:/Users/24378/AppData/Local/deskpet/models") / _SUBDIR,
        Path(r"F:/DeskPetData/models") / _SUBDIR,
