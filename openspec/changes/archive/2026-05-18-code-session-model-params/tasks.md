...
- [x] 6.4 `openspec validate code-session-model-params --strict` → valid (EXIT=0); committed to `feat/2026-05-18-session-and-e2e`; archived as `2026-05-18-code-session-model-params` (spec promoted to `openspec/specs/code-session-model-params/spec.md`, +4 requirements).
