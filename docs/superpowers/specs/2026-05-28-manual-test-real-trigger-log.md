...
```
Base directory for this skill: C:\Users\you\.claude\skills\sp-goal-management
...
```
Base directory for this skill: C:\Users\you\.claude\skills\sp-multi-agent-orchestration
