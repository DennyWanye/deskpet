...
Run: `cd /path/to/deskpet\backend && python -m pytest tests/test_barge_in_filter.py -v`
...
Run: `cd /path/to/deskpet\backend && python -m pytest tests/test_silero_vad_dynamic.py -v`
...
Run: `cd /path/to/deskpet\backend && python -m pytest --tb=short -q`
Expected: All pass
...
Run: `cd /path/to/deskpet\backend && python -m pytest tests/test_voice_pipeline_barge_in.py -v`
...
Run: `cd /path/to/deskpet\tauri-app && npx tsc --noEmit`
Expected: 0 errors
...
Run terminal 1: `cd /path/to/deskpet\backend && set DESKPET_DEV_MODE=1 && .venv\Scripts\python.exe main.py`
Run terminal 2: `cd /path/to/deskpet && .venv\Scripts\python.exe scripts/e2e_barge_in_m1.py`
...
Run: `cd /path/to/deskpet\backend && python -m pytest tests/test_edge_tts_pcm.py -v`
...
Run: `cd /path/to/deskpet\backend && set DESKPET_DEV_MODE=1 && .venv\Scripts\python.exe main.py`

Verify log shows ffmpeg usage when TTS triggers.

- [ ] **Step 2: Start frontend**

Run: `cd /path/to/deskpet\tauri-app && npm run dev`
...
Run: `cd /path/to/deskpet && python scripts/perf/barge_in.py`
